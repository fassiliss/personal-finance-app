            ...
            <div className="w-full max-w-md">
                ...
                <div className="rounded-xl border border-slate-800 bg-slate-900 p-6 space-y-4">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 rounded-lg border border-slate-700 bg-slate-950 px-4 py-2.5 text-sm font-medium text-slate-200 hover:bg-slate-800 transition-colors"
                    >
